{
  flake.modules.nixos.base =
    { pkgs, ... }:
    {
      nixpkgs.overlays = [
        (final: prev: {
          vscode-extensions = prev.vscode-extensions // prev.callPackage ./_vscode-extensions { };
          vimPlugins = prev.vimPlugins // prev.callPackage ./_vim-plugins { };
          osu-mime-types = prev.callPackage ./_osu-mime-types { };
